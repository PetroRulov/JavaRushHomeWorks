package com.javarush.test.samples.polymorphismus.rtti.typeinfo.toys;
...
public class ToyTest {
    ...
    public static void main(String[] args) {
        Class c = null;
        try {
            c = Class.forName("com.javarush.test.samples.polymorphismus.rtti.typeinfo.toys.FancyToy");
